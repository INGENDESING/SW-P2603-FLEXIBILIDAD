...
recirculaci\'{o}n 2 del sistema DDW (SIM-003) del proyecto P2603 SW-K60,
...
la descarga de la bomba de recirculaci\'{o}n 2 del sistema DDW, modelada a partir
del isom\'{e}trico PCF104 emitido por el equipo de dise\~{n}o en AutoCAD Plant
3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-003 conduce agua desde la boquilla de descarga de la bomba de
recirculaci\'{o}n 2 del sistema DDW hacia el proceso aguas abajo. Est\'{a}
construida en acero inoxidable ASTM A312 TP 304L, Sch 10S, en di\'{a}metros
nominales de 1.5 y 6~NPS, e incluye codos de 90$^\circ$ de radio largo
(ASME B16.9), uniones bridadas tipo \textit{lap joint} con \textit{stub-end}
(ASME B16.5), una v\'{a}lvula de bola con actuador neum\'{a}tico y conexiones
roscadas/forjadas de la derivaci\'{o}n menor (v\'{a}lvula de bola NPT y
\textit{sockolet} 3000~lb, ASME B16.11). El modelo de elementos finitos
comprende 22 nodos evaluados, con soportes r\'{i}gidos verticales (+Y) en los nodos 90 y
135 y soportes r\'{i}gidos con holgura en los nodos 50 y 150; los extremos del
tramo analizado incorporan los desplazamientos impuestos de la conexi\'{o}n con
el equipo y del empalme aguas abajo.
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-003 mantiene los esfuerzos
