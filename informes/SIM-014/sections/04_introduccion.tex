...
el an\'{a}lisis de flexibilidad de la l\'{i}nea de descarga del TMS (SIM-014)
del proyecto P2603 SW-K60, ejecutado para Smurfit Westrock con el software
CAESAR II 2019~\cite{caesar2_ug_2019}.
...
transferencia y servicios auxiliares de la ampliaci\'{o}n; todas ellas comparten
las mismas bases de dise\~{n}o (secci\'{o}n~\ref{sec:bases}). La l\'{i}nea objeto
de este informe corresponde a la descarga del TMS, modelada a partir del
isom\'{e}trico PCF112 emitido por el equipo de dise\~{n}o en AutoCAD Plant
3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-014 (tag PMTUB6-030-PUB-6"-150H2A) conduce agua desde la
descarga del TMS hacia el sistema aguas abajo. Est\'{a} construida en acero
inoxidable ASTM A312 TP 304L, Sch 10S, en di\'{a}metro nominal de 6~NPS, con
derivaciones menores de 1~NPS, e incluye una manguera flexible en el inicio del
tramo, codos de radio largo (ASME B16.9), uniones bridadas de 150~lb
(ASME B16.5) y v\'{a}lvulas de compuerta de cuchilla (\textit{through conduit
knife gate}) Cl.~150 tipo \textit{lug} RF, una de ellas con actuador
neum\'{a}tico. El recorrido es predominantemente vertical. El modelo de
elementos finitos comprende 21 nodos; la soporter\'{i}a intermedia incluye una
restricci\'{o}n r\'{i}gida lateral en el nodo 40 y un conjunto de restricciones
en el nodo 105 (gu\'{i}a lateral con holgura de 25~\si{mm}, soporte vertical +Y
y gu\'{i}a axial con holgura de 25~\si{mm}). El modelo incluye adem\'{a}s una
tee no reforzada en el nodo 70 y conexiones tipo \textit{weldolet} en los
nodos 110 y 140 para las derivaciones de 1~NPS.
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-014 mantiene los esfuerzos
