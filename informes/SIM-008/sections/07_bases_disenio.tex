...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-008.}
...
\begin{table}[htbp]
    \centering
    \caption{Propiedades del fluido de proceso.}
    ...
    \begin{tabularx}{\textwidth}{@{}NXccc@{}}
        ...
        \midrule
        & Fluido & \multicolumn{2}{c}{Licor de recirculaci\'{o}n DDW} & Cliente \\
...
(CA~=~0), conforme a la especificaci\'{o}n de tuber\'{i}as del proyecto. Los
accesorios son de material ASTM A403 Gr WP 304L. La Tabla~\ref{tab:tuberia}
resume la especificaci\'{o}n extra\'{i}da del archivo PCF del isom\'{e}trico.

\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-008 (fuente: PCF106).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        \midrule
        & Tuber\'{i}a & ASTM A312 Gr TP 304L, ASME B36.19, Sch 10S, ERW / sin costura, extremos PE \\
        & Di\'{a}metros nominales presentes & 6 y 8 NPS \\
        & Codos 90$^\circ$ radio largo & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Tees reductoras & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Reducciones conc\'{e}ntricas & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Uniones bridadas \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
        & V\'{a}lvula de bola de paso total & NPT, ASME B16.10 \\
...
Los equipos conectados al tramo analizado son la lavadora de doble disco DDW, en
el extremo aguas arriba, y la bomba de recirculaci\'{o}n 1, cuya boquilla de
succi\'{o}n se modela en el nodo 230 con restricciones r\'{i}gidas con holgura
en las tres direcciones. Los datos dimensionales y los admisibles de carga de
las boquillas de los equipos no forman parte del alcance del modelo de
flexibilidad; las cargas que la l\'{i}nea transmite a dichos extremos se
reportan en la secci\'{o}n~\ref{sec:resultados}.
