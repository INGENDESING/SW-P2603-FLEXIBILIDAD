...
el an\'{a}lisis de flexibilidad de la l\'{i}nea de succi\'{o}n de la bomba de
recirculaci\'{o}n 1 de la lavadora de doble disco DDW (SIM-008) del proyecto
P2603 SW-K60, ejecutado para Smurfit Westrock con el software CAESAR II
...
la succi\'{o}n de la bomba de recirculaci\'{o}n 1 de la lavadora DDW, modelada a
partir del isom\'{e}trico PCF106 emitido por el equipo de dise\~{n}o en AutoCAD
Plant 3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-008 conduce el licor de recirculaci\'{o}n desde la lavadora de
doble disco DDW hacia la boquilla de succi\'{o}n de la bomba de recirculaci\'{o}n
1. Est\'{a} construida en acero inoxidable ASTM A312 TP 304L, Sch 10S seg\'{u}n
ASME B36.19, en di\'{a}metros nominales de 6 y 8~NPS, e incluye codos de
90$^\circ$ de radio largo, tees reductoras y reducciones conc\'{e}ntricas
(ASME B16.9), uniones bridadas tipo \textit{lap joint} con \textit{stub-end}
(ASME B16.5 / B16.9-C) y una v\'{a}lvula de bola de paso total. El modelo de
elementos finitos comprende los nodos 10 a 230, con soportes r\'{i}gidos
verticales (+Y) en los nodos 10, 60, 100, 130 y 180, gu\'{i}as r\'{i}gidas con
holgura (\textit{w/gap}) en los nodos 10 y 180 (direcci\'{o}n $Z$) y una
restricci\'{o}n r\'{i}gida con holgura en las tres direcciones en el extremo de
la boquilla de succi\'{o}n de la bomba (nodo 230).
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-008 mantiene los esfuerzos
...
con el admisible sostenido reportado por el modelo (\num{115142.4}~\si{kPa},
secci\'{o}n~\ref{sec:resultados}) y con el admisible de expansi\'{o}n
(\num{261900.9}~\si{kPa}) calculado con la forma liberal de la
ecuaci\'{o}n (1b).
