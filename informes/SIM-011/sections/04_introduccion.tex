...
el an\'{a}lisis de flexibilidad de la l\'{i}nea de descarga de la bomba PP30BT03
(SIM-011) del proyecto P2603 SW-K60, ejecutado para Smurfit Westrock con el
software CAESAR II 2019~\cite{caesar2_ug_2019}.
...
la descarga de la bomba PP30BT03, modelada a partir del isom\'{e}trico PCF108
emitido por el equipo de dise\~{n}o en AutoCAD Plant 3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-011 conduce agua desde la boquilla de descarga de la bomba
PP30BT03 hacia el sistema de tuber\'{i}as aguas abajo. Est\'{a} construida en
acero inoxidable ASTM A312 TP 304L Sch 40S (especificaci\'{o}n SS40S del
proyecto), en di\'{a}metros nominales de 1.5 a 12~NPS con predominio de 10~NPS,
e incluye codos de 90$^\circ$ de radio largo (ASME B16.9), tees reductoras,
reducciones conc\'{e}ntricas y exc\'{e}ntricas, uniones bridadas tipo
\textit{lap joint} con \textit{stub-end} (ASME B16.5 / B16.9-C) y v\'{a}lvulas
de compuerta de cuchilla de 150~lb tipo \textit{lug} (ASME B16.10), entre ellas
una de 10~NPS con volante de engranaje c\'{o}nico y una de 10~NPS con actuador
neum\'{a}tico. El modelo de elementos finitos comprende 156 evaluaciones de
extremo de elemento en el caso cr\'{i}tico, con restricciones tipo soporte
r\'{i}gido vertical (+Y), gu\'{i}as laterales (Rigid X) y cuatro anclas (ANC):
la boquilla de descarga de la bomba (nodo 110) y los extremos de conexi\'{o}n
aguas abajo (nodos 420, 540 y 660).
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-011 mantiene los esfuerzos
