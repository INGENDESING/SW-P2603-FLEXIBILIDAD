...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        \midrule
        & Modelo de elementos finitos de la l\'{i}nea SIM-011 (job CAESAR P2603-PR-SIM-011), desde la boquilla de descarga de la bomba PP30BT03 hasta los anclas aguas abajo, generado desde el isom\'{e}trico PCF108. \\
        ...
        & Verificaci\'{o}n de cumplimiento de c\'{o}digo (\textit{code compliance}) y elaboraci\'{o}n del presente informe t\'{e}cnico con c\'{o}digo de documento I24.104-PP30-PP01-P-DOCS-186. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        & Cargas en boquillas de equipos frente a criterios de fabricante (p.\,ej. API 610 para la bomba PP30BT03): el modelo reporta cargas en las anclas, pero su comparaci\'{o}n con admisibles del equipo requiere los datos del fabricante, no disponibles a la fecha. \\
