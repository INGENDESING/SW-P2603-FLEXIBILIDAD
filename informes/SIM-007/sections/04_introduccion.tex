...
el an\'{a}lisis de flexibilidad de la l\'{i}nea de la bomba de vac\'{i}o nueva
(SIM-007) del proyecto P2603 SW-K60, ejecutado para Smurfit Westrock con el
...
la conexi\'{o}n de la bomba de vac\'{i}o nueva, modelada a partir del
isom\'{e}trico PCF107 emitido por el equipo de dise\~{n}o en AutoCAD Plant 3D
2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-007 conecta la bomba de vac\'{i}o nueva con el sistema de
proceso aguas arriba. Est\'{a} construida en acero inoxidable ASTM A312 TP 304L,
Sch 10S, en di\'{a}metros nominales de 4, 6 y 8~NPS, e incluye codos de
90$^\circ$ y 45$^\circ$ de radio largo (ASME B16.9), reducciones
conc\'{e}ntricas, una brida \textit{slip-on} de 150~lb (ASME B16.5) y una
uni\'{o}n bridada tipo \textit{lap joint} con \textit{stub-end} (ASME B16.5 /
B16.9-C). El modelo de elementos finitos se extiende entre dos anclas (ANC) en
los extremos del tramo analizado (nodos 10 y 110), con un soporte
r\'{i}gido vertical (+Y) y una gu\'{i}a axial con holgura (Z \textit{w/gap}) en
el nodo intermedio 75.
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-007 mantiene los esfuerzos
...
admisible sostenido reportado por el modelo (\num{115142.4}~\si{kPa}); el
admisible de expansi\'{o}n del caso cr\'{i}tico es \num{273789.8}~\si{kPa}
