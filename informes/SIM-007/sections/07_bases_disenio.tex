...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-007.}
...
\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-007 (fuente: PCF107).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        & Di\'{a}metros nominales presentes & 4, 6 y 8 NPS \\
        ...
        & Brida \textit{slip-on} & 150~lb, ASME B16.5 \\
        & Uni\'{o}n bridada \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
...
El \'{u}nico equipo conectado al tramo analizado es la bomba de vac\'{i}o nueva,
cuya boquilla se modela como ancla (restricci\'{o}n total) en el extremo del
tramo. Los datos del equipo (fabricante, modelo y cargas admisibles en boquilla)
no forman parte del alcance del modelo de flexibilidad; las cargas que la
l\'{i}nea transmite a dicha boquilla se reportan en la
secci\'{o}n~\ref{sec:resultados} y su comparaci\'{o}n con los admisibles del
fabricante queda como verificaci\'{o}n externa (secci\'{o}n~\ref{sec:alcance}).
