...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        \midrule
        & Modelo de elementos finitos de la l\'{i}nea SIM-009 (job CAESAR P2603-PR-SIM-009), desde la conexi\'{o}n aguas arriba con el sistema DDW hasta la boquilla de succi\'{o}n de la bomba de recirculaci\'{o}n 2, generado desde el isom\'{e}trico PCF105. \\
        ...
        & Verificaci\'{o}n de cumplimiento de c\'{o}digo (\textit{code compliance}) y elaboraci\'{o}n del presente informe t\'{e}cnico con c\'{o}digo de documento I24.104-PP30-PP01-P-DOCS-184. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        & Cargas en boquillas de equipos frente a criterios de fabricante (p.\,ej. API 610 para bombas): el modelo reporta cargas en la conexi\'{o}n con la bomba, pero su comparaci\'{o}n con admisibles del equipo requiere los datos del fabricante, no disponibles a la fecha. \\
