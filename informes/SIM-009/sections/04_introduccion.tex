...
recirculaci\'{o}n 2 del sistema DDW (SIM-009) del proyecto P2603 SW-K60,
ejecutado para Smurfit Westrock con el software CAESAR II 2019~\cite{caesar2_ug_2019}.
...
la succi\'{o}n de la bomba de recirculaci\'{o}n 2 del sistema DDW, modelada a
partir del isom\'{e}trico PCF105 emitido por el equipo de dise\~{n}o en AutoCAD
Plant 3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-009 conduce agua del sistema DDW hacia la boquilla de
succi\'{o}n de la bomba de recirculaci\'{o}n 2. Est\'{a} construida en acero
inoxidable ASTM A312 TP 304L, Sch 10S, en di\'{a}metros nominales de 6 y
8~NPS, e incluye codos de 90$^\circ$ de radio largo (ASME B16.9), reducciones
conc\'{e}ntricas, una tee reductora, uniones bridadas tipo \textit{lap joint}
con \textit{stub-end} (ASME B16.5 / B16.9-C) y una v\'{a}lvula de bola de
1.5~NPS en el ramal de instrumentaci\'{o}n. El modelo de elementos finitos
comprende 44 nodos evaluados, con restricciones tipo soporte r\'{i}gido
vertical (+Y), gu\'{i}as r\'{i}gidas con holgura y la conexi\'{o}n a la boquilla
de la bomba en el extremo aguas abajo (nodo 220).
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-009 mantiene los esfuerzos
...
B31.3-2016 a la temperatura de operaci\'{o}n es $S_c = S_h = 16.7$~ksi
(\num{115.1}~\si{MPa}), valor consistente con el admisible sostenido reportado
