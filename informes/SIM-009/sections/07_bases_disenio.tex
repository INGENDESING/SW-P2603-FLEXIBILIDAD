...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-009.}
...
\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-009 (fuente: PCF105).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        \midrule
        & Tuber\'{i}a & ASTM A312 Gr TP 304L, ASME B36.19, Sch 10S, sin costura, extremos PE/BW \\
        & Di\'{a}metros nominales presentes & 6 y 8 NPS (ramal de instrumentaci\'{o}n de 1.5 NPS) \\
        & Codos 90$^\circ$ radio largo & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Reducciones conc\'{e}ntricas y tee reductora & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Uniones bridadas \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
        & V\'{a}lvula de bola (ramal de instrumentaci\'{o}n) & 1.5~NPS, paso total, NPT, ASME B16.10 \\
...
recirculaci\'{o}n 2 del sistema DDW, cuya boquilla de succi\'{o}n se modela en
el nodo 220 con gu\'{i}as r\'{i}gidas con holgura en las tres direcciones. Los
datos mec\'{a}nicos de la bomba no forman parte del alcance del modelo de
flexibilidad; las cargas que la l\'{i}nea transmite a dicha boquilla se
