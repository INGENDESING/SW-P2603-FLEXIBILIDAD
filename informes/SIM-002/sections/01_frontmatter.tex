...
\begin{frontmatter}
	...
	\begin{abstract}
		...
		de la bomba de recirculaci\'{o}n 1 del sistema DDW (l\'{i}nea SIM-002,
		job CAESAR P2603-PR-SIM-002) del proyecto P2603 SW-K60 para Smurfit
		Westrock, ejecutado conforme a ASME B31.3-2016 con el software
		CAESAR II 2019. La l\'{i}nea, construida en acero inoxidable
		ASTM A312 TP 304L Sch 10S, opera con agua a 1241~\si{kPa}~g y
		...
		El esfuerzo m\'{a}ximo de c\'{o}digo fue \num{39668.2}~\si{kPa} frente
		a un admisible de \num{115142.4}~\si{kPa}, correspondiente al nodo 78
		en el caso sostenido 6 (SUS) W+P2, con una relaci\'{o}n de
		utilizaci\'{o}n de 34.5~\%. La evaluaci\'{o}n de cumplimiento de
