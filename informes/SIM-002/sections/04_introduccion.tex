...
el an\'{a}lisis de flexibilidad de la l\'{i}nea de descarga de la bomba de
recirculaci\'{o}n 1 del sistema DDW (SIM-002) del proyecto P2603 SW-K60,
...
la descarga de la bomba de recirculaci\'{o}n 1 del sistema DDW, modelada a partir
del isom\'{e}trico PCF103 emitido por el equipo de dise\~{n}o en AutoCAD Plant
3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-002 conduce agua desde la boquilla de descarga de la bomba de
recirculaci\'{o}n 1 del sistema DDW hacia el proceso aguas abajo. Est\'{a}
construida en acero inoxidable ASTM A312 TP 304L, Sch 10S, en di\'{a}metro
nominal de 6~NPS, e incluye codos de 90$^\circ$ y 45$^\circ$ de radio largo
(ASME B16.9), bridas \textit{slip-on} y uniones bridadas tipo \textit{lap joint}
con \textit{stub-end} de 150~lb (ASME B16.5 / B16.9-C), una v\'{a}lvula de
retenci\'{o}n tipo \textit{swing} Cl.~150 (ASME B16.10), v\'{a}lvulas de bola
(una de ellas con actuador neum\'{a}tico), un medidor magn\'{e}tico de flujo
Cl.~150 y conexiones forjadas de la derivaci\'{o}n menor (\textit{sockolet}
3000~lb, ASME B16.11). El modelo de elementos finitos comprende 36 nodos
evaluados; la soporter\'{i}a incluye soportes r\'{i}gidos verticales (+Y) en los
nodos 25 y 70, restricciones r\'{i}gidas con holgura (\textit{w/gap}) en los
nodos 10 y 170 y una restricci\'{o}n r\'{i}gida traslacional en el nodo 130.
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-002 mantiene los esfuerzos
