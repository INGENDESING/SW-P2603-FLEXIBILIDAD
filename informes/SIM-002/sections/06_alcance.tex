...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        \midrule
        & Modelo de elementos finitos de la l\'{i}nea SIM-002 (job CAESAR P2603-PR-SIM-002), desde la boquilla de descarga de la bomba de recirculaci\'{o}n 1 del sistema DDW hasta el empalme aguas abajo, generado desde el isom\'{e}trico PCF103. \\
        ...
        & Verificaci\'{o}n de cumplimiento de c\'{o}digo (\textit{code compliance}) y elaboraci\'{o}n del presente informe t\'{e}cnico con c\'{o}digo de documento I24.104-PP30-PP01-P-DOCS-180. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        & Cargas en boquillas de equipos frente a criterios de fabricante (p.\,ej. API 610 para bombas): la conexi\'{o}n con la bomba se modela con restricciones r\'{i}gidas con holgura, por lo que la comparaci\'{o}n de las cargas en la boquilla con admisibles del equipo requiere los datos del fabricante, no disponibles a la fecha. \\
