...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-002.}
...
\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-002 (fuente: PCF103).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        & Di\'{a}metro nominal presente & 6 NPS \\
        & Codos 90$^\circ$ y 45$^\circ$ radio largo & ASTM A403 Gr WP 304L, ASME B16.9, Sch 10S, BW \\
        & Bridas \textit{slip-on} & 150~lb, RF, ASME B16.5, ASTM A182 Gr F304L \\
        & Uniones bridadas \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
        & V\'{a}lvula de retenci\'{o}n \textit{swing} & Cl.~150, RF, ASME B16.10 \\
        & V\'{a}lvulas de bola & Paso total, NPT, ASME B16.10; una con actuador neum\'{a}tico \\
        & Medidor magn\'{e}tico de flujo & Cl.~150, RF \\
        & Conexiones forjadas de la derivaci\'{o}n menor & \textit{Sockolet} 3000~lb, ASME B16.11, ASTM A182 Gr F304L \\
...
recirculaci\'{o}n 1 del sistema DDW, cuya boquilla de descarga marca el inicio
del modelo (nodo 10). La conexi\'{o}n con el equipo y el empalme aguas abajo
(nodo 170) se modelan mediante restricciones r\'{i}gidas con holgura
(\textit{w/gap}); las cargas que la l\'{i}nea transmite a los soportes se
