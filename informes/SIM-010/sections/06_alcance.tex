...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        \midrule
        & Modelo de elementos finitos de la l\'{i}nea SIM-010 (job CAESAR P2603-PR-SIM-010), desde el extremo aguas arriba hasta la boquilla de succi\'{o}n de la bomba de recirculaci\'{o}n 3 DDW, generado desde el isom\'{e}trico PCF102. \\
        ...
        & Verificaci\'{o}n de cumplimiento de c\'{o}digo (\textit{code compliance}) y elaboraci\'{o}n del presente informe t\'{e}cnico con c\'{o}digo de documento I24.104-PP30-PP01-P-DOCS-185. \\
        \bottomrule
    \end{tabularx}
\end{table}
