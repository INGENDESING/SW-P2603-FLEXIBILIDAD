...
paquete de flexibilidad. No admisible modificarlas sin un nuevo ciclo de
...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-010.}
...
(CA~=~0), conforme a la especificaci\'{o}n de tuber\'{i}as del proyecto (spec
SSS3/SS3). Los accesorios son de material ASTM A403 Gr WP 304L. La
Tabla~\ref{tab:tuberia} resume la especificaci\'{o}n extra\'{i}da del archivo
PCF del isom\'{e}trico.

\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-010 (fuente: PCF102).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        \midrule
        & Tuber\'{i}a & ASTM A312 Gr TP 304L, ASME B36.19, Sch 10S (ERW y \textit{seamless}), extremos PE/BW \\
        & Di\'{a}metros nominales presentes & 4 y 6 NPS (conexiones de instrumentaci\'{o}n menores) \\
        & Codos 90$^\circ$ y 45$^\circ$ radio largo & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Reducciones conc\'{e}ntricas y tes & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Uniones bridadas \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
        & V\'{a}lvulas de bola y medidor de flujo magn\'{e}tico & 150~lb, ASME B16.10 / B16.5 \\
        & \textit{Sockolets} de instrumentaci\'{o}n & 3000~lb, ASME B16.11, ASTM A182 Gr F304L \\
...
recirculaci\'{o}n 3 del sistema DDW, cuya boquilla de succi\'{o}n se modela como
ancla (restricci\'{o}n total). Los datos de placa de la bomba no forman parte
...
comparaci\'{o}n con los admisibles del fabricante se identifica como
verificaci\'{o}n externa pendiente (secci\'{o}n~\ref{sec:alcance}).
