...
recirculaci\'{o}n 3 del sistema DDW (SIM-010) del proyecto P2603 SW-K60,
...
la succi\'{o}n de la bomba de recirculaci\'{o}n 3 del sistema DDW, modelada a
partir del isom\'{e}trico PCF102 emitido por el equipo de dise\~{n}o en AutoCAD
Plant 3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-010 conduce agua de proceso hacia la boquilla de succi\'{o}n de
la bomba de recirculaci\'{o}n 3 del sistema DDW. Est\'{a} construida en acero
inoxidable ASTM A312 TP 304L, Sch 10S, en di\'{a}metros nominales de 4 y 6~NPS,
e incluye codos de 90$^\circ$ y 45$^\circ$ de radio largo (ASME B16.9),
reducciones conc\'{e}ntricas, tes, uniones bridadas tipo \textit{lap joint} con
\textit{stub-end} (ASME B16.5), v\'{a}lvulas de bola y un medidor de flujo
magn\'{e}tico. El modelo de elementos finitos comprende 178 nodos evaluados, con
restricciones tipo soporte r\'{i}gido vertical (+Y), gu\'{i}as laterales con
holgura y dos anclas (ANC) en los extremos del tramo analizado (nodos 520 y
590).
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-010 mantiene los esfuerzos
...
l\'{i}nea (ASTM A312 TP 304L), el modelo aplica un admisible b\'{a}sico
