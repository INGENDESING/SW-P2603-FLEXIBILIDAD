...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-012.}
...
\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-012 (fuente: PCF111).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        \midrule
        & Tuber\'{i}a & ASTM A312 Gr TP 304L, ASME B36.19, Sch 10S (tramos Sch 40S), extremos PE/BW \\
        & Di\'{a}metros nominales presentes & 6, 8, 10, 12 y 16 NPS \\
        & Codos 90$^\circ$ y 45$^\circ$ radio largo & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Reducciones exc\'{e}ntricas & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Uniones bridadas \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
        & V\'{a}lvulas de compuerta de cuchilla & 150~lb, CF8M, tipo lug, RF, ASME B16.5 / B16.10 \\
...
El \'{u}nico equipo conectado al tramo analizado es el tanque TK Blowtank, cuya
boquilla de succi\'{o}n se modela como ancla (restricci\'{o}n total). Los datos
dimensionales del tanque no forman parte del alcance del modelo de flexibilidad;
las cargas que la l\'{i}nea transmite a dicha boquilla se reportan en la
