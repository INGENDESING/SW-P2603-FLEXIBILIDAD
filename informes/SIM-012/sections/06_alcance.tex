...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}NX@{}}
        ...
        \midrule
        & Modelo de elementos finitos de la l\'{i}nea SIM-012 (job CAESAR P2603-PR-SIM-012), desde la boquilla de succi\'{o}n del tanque TK Blowtank hasta el ancla aguas abajo, generado desde el isom\'{e}trico PCF111. \\
        ...
        & Verificaci\'{o}n de cumplimiento de c\'{o}digo (\textit{code compliance}) y elaboraci\'{o}n del presente informe t\'{e}cnico con c\'{o}digo de documento I24.104-PP30-PP01-P-DOCS-187. \\
        \bottomrule
    \end{tabularx}
\end{table}
