...
el an\'{a}lisis de flexibilidad de la l\'{i}nea de descarga del tanque de
nivelaci\'{o}n (SIM-013) del proyecto P2603 SW-K60,
...
Dentro del paquete de an\'{a}lisis de flexibilidad se han evaluado nueve
l\'{i}neas asociadas a los sistemas de lavado (DDW), recirculaci\'{o}n, vac\'{i}o,
transferencia y tanque de nivelaci\'{o}n; todas ellas comparten las mismas bases de dise\~{n}o
(secci\'{o}n~\ref{sec:bases}). La l\'{i}nea objeto de este informe corresponde a
la descarga del tanque de nivelaci\'{o}n, modelada a partir
del isom\'{e}trico PCF113 emitido por el equipo de dise\~{n}o en AutoCAD Plant
3D 2027.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Descripcion del Sistema}

La l\'{i}nea SIM-013 conduce agua desde la boquilla de descarga del tanque de
nivelaci\'{o}n hacia el proceso aguas abajo. Est\'{a}
construida en acero inoxidable ASTM A312 TP 304L, Sch 10S, en di\'{a}metros
nominales de 12 y 8~NPS, con una derivaci\'{o}n menor de 6~NPS, e incluye
codos de 90$^\circ$ y 45$^\circ$ de radio largo (ASME B16.9), un reductor
exc\'{e}ntrico de 12 a 8~NPS (ASME B16.9), uniones bridadas tipo
\textit{lap joint} con \textit{stub-end} de 150~lb (ASME B16.5 / B16.9-C) y
v\'{a}lvulas de compuerta de cuchilla (\textit{knife gate}) Cl.~150, dos de
ellas con volante de engranaje c\'{o}nico y una con actuador neum\'{a}tico.
El modelo de elementos finitos comprende 28 nodos
evaluados; la soporter\'{i}a intermedia incluye soportes r\'{i}gidos verticales
(+Y) en los nodos 100 y 120, y los extremos del tramo (nodos 10 y 160)
corresponden a las conexiones con el tanque de nivelaci\'{o}n y con el sistema
aguas abajo.
...
geom\'{e}trica y de soporter\'{i}a de la l\'{i}nea SIM-013 mantiene los esfuerzos
