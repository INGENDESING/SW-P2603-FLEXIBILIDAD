...
congeladas del proyecto P2603 SW-K60 y son comunes a las nueve l\'{i}neas del
...
\begin{table}[htbp]
    \centering
    \caption{Condiciones de dise\~{n}o y operaci\'{o}n de la l\'{i}nea SIM-013.}
...
\begin{table}[htbp]
    \centering
    \caption{Especificaci\'{o}n de tuber\'{i}as y accesorios de la l\'{i}nea SIM-013 (fuente: PCF113).}
    \label{tab:tuberia}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}N>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        & Di\'{a}metros nominales presentes & 12 y 8 NPS; derivaci\'{o}n menor de 6 NPS \\
        & Codos 90$^\circ$ y 45$^\circ$ radio largo & ASTM A403 Gr WP 304L, ASME B16.9, Sch 10S, BW \\
        & Reductor exc\'{e}ntrico 12 a 8 NPS & ASTM A403 Gr WP 304L, ASME B16.9, BW \\
        & Uniones bridadas \textit{lap joint} + \textit{stub-end} & 150~lb, ASME B16.5 / B16.9-C \\
        & V\'{a}lvulas de compuerta de cuchilla (\textit{knife gate}) & Cl.~150, tipo \textit{lug}, RF; dos con volante de engranaje c\'{o}nico y una con actuador neum\'{a}tico \\
...
El equipo conectado al inicio del tramo analizado es el tanque de
nivelaci\'{o}n, cuya boquilla de descarga marca el inicio
del modelo (nodo 10); el extremo aguas abajo corresponde al nodo 160. Las
cargas que la l\'{i}nea transmite a los soportes intermedios se
